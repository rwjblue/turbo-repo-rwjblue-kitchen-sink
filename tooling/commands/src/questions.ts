...
export const questions: QuestionTemplate[] = [
  ...
  },
  {
    ...
    options: ["Console.log", "Debugger", "Unit Tests", "Print Statements", "Step Through"]
  },
  {
  ...
  },
  {
    ...
    options: ["Documentation", "Video Tutorials", "Books", "Trial & Error", "Side Projects"]
  },
  {
  ...
  },
  {
    ...
    options: ["CSS Modules", "Tailwind", "Styled Components", "SASS", "CSS-in-JS"]
  },
  {
  ...
  },
  {
    ...
    options: ["Git Flow", "Trunk Based", "Feature Branches", "GitHub Flow", "GitLab Flow"]
  },
  {
    question: "How do you handle errors?",
    options: ["Try/Catch", "Error Boundaries", "Global Handler", "Logger", "Sentry"]
  },
  {
  ...
  },
  {
    ...
    options: ["Code Splitting", "Lazy Loading", "Caching", "Memoization", "Bundle Analysis"]
  },
  {
  ...
  },
  {
    ...
    options: [".env files", "CI/CD Variables", "Secret Manager", "Config Files", "Runtime Config"]
  },
  {
  ...
  },
  {
    ...
    options: ["React Hook Form", "Formik", "Final Form", "Native Forms", "Zod + React Hook Form"]
  },
  {
  ...
  },
  {
    ...
    options: ["Mobile First", "Desktop First", "Component First", "Utility First", "CSS-in-JS"]
  },
  {
