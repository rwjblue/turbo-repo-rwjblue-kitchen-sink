...
describe('PollApp', () => {
  ...
  it('adds new option input when clicking add option button', () => {
    const addOptionBtn = document.getElementById('addOptionBtn') as HTMLButtonElement;
  ...
  it('handles form submission', async () => {
    ...
    const optionInput = document.querySelector('#optionsContainer input') as HTMLInputElement;
